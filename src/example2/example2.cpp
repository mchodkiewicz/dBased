...
int main(int argc, char *argv[])
{
    ...
    discamb::SpaceGroupOperation mirrorPlane(string("1/2-Y, 1/2-X, Z"));
    // or alternatively 
    ...
    crystal.adpConvention = discamb::structural_parameters_convention::AdpConvention::U_cif;
    ...
    crystal.xyzCoordinateSystem = discamb::structural_parameters_convention::XyzCoordinateSystem::fractional; 
